...
- **apps Share** (needed for access to the manifest)
...
2. Review Step 2 to set up PsTools, otherwise skip to Step 3 if already installed.
   - PsTools is available at `\\contoso.com\shared\apps\Support-Applications\DONUT\Production\PsTools`.
...
- **Deploying Changes:**
  - Navigate to `\\contoso.com\shared\apps\Support-Applications\DONUT\Development`
