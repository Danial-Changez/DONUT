...
# $manifestFile = '\\contoso.com\shared\apps\Support-Applications\DONUT\Development\manifest.json'
# $sharedRoot = '\\contoso.com\shared\apps\Support-Applications\DONUT\Development'
$manifestFile = '\\contoso.com\shared\SCRATCH\DC\manifest.json'
$sharedRoot = '\\contoso.com\shared\SCRATCH\DC'
    ...
    if (Test-Path $uninstallPath) {
        ...
        foreach ($subKey in $subKeys) {
            try {
                ...
                if ($app.DisplayName -like "*DONUT*" -or $app.Publisher -like "*Bakery*") {
